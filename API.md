...
function getData() {
  const response = 
    await fetch(`https://iso3166-updates.com/api/name/${input_subdivision_name}`); 
  const data = await response.json()
}
